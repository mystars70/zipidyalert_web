...
function getListMessage() {
    ...
    var numId = 0;
    //console.log(url);
    var tTable = $('#messageList').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: url,
        ...
        columns: [
            { 
                ...
                render: function ( data, type, fullData, meta ) {
                    urlNewLink = baseUrl + '/admin/messages/messages-detail/' + fullData.message_id;
            ...
            { 
                ...
                render: function ( data, type, fullData, meta ) {
                    urlNewLink = baseUrl + '/admin/messages/messages-detail/' + fullData.message_id;
                    return '<a href="' + urlNewLink + '">' + fullData.title + '</a>';
                }
            },
            { 
                data: 'username',
                ...
                render: function ( data, type, fullData, meta ) {
                    urlNewLink = baseUrl + '/admin/messages/messages-detail/' + fullData.message_id;
                    return '<a href="' + urlNewLink + '">' + fullData.username + '</a>';
                }
            },
            { 
                data: 'created_at',
            ...
            { 
                ...
                name: 'Total Reply',
                render: function ( data, type, fullData, meta ) {
                    if (fullData.total_reply == null) {
                        return 0;
                    } else {
                        return fullData.total_reply;
                    }
                }
            },
    ...
    tTable.on( 'order.dt search.dt', function () {
        tTable.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
            ...
            //cell.innerHTML = '' + cell.innerHTML + '">' + numId + '</a>';
            //cell.innerHTML = '<a href="' + cell.innerHTML + '"' + numId + '</a>';
        } );
    } ).draw();
}
...
function getListReply() {
    // get message user business list
    var url = baseUrl + "/admin/messages/ajax-reply-list";
    var numId = 0;
    //console.log(url);
