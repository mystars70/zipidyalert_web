...
<div id='detail_message_wrap'>
    <div class="popup-content">
        <div class="rows detail-top-header distance-api" data-lat="<?php echo $mesage->lat ?>" data-lon="<?php echo $mesage->lon; ?>">
            <div class="col-lg-6">
                <div class="user-wrap">
                <?php if ($mesage->avatar && file_exists(env('DIR_UPLOAD_USER').$mesage->avatar)) :?>
                    <img src="<?php echo url(env('DIR_UPLOAD_USER').$mesage->avatar)?>">
                <?php else :?>
                    <?php $helpDb->noImage($mesage->firstname); ?> 
                <?php endif;?>
                    
                    <div class="user-info">
                        <span><?php echo $mesage->firstname.' '.$mesage->lastname; ?></span>
